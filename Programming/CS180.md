...
- a **famous** person is defined as someone who *everyone* else knows, but knows *no-one* else:
...
- DFS *implementation*:
  ...
  2. can naturaly use recursion to start from a root and explore each neighboring node as long as it has not been visited
