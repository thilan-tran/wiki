...
- *calling* a subroutine:
  ...
  - saving certain nonvolatile/callee-saved registers so that they can be restored
...
- processes should be used when:
  - programs should distinct and isolated from interference or failures of another process
