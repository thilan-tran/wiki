...
- security has intrinsic possibilities of failure:
    ...
    - instead, assume security can always fail, and try to detect intruders in an automated fashion
    ...
    - in a **network approach**, we do the same for a whole local area network:
        ...
        - easier to properly configure for manual installations
        - observe things affecting multiple machines
        - even more information passes on the network, cannot process it all
